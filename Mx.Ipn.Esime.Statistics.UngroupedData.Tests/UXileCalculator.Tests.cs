namespace Mx.Ipn.Esime.Statistics.UngroupedData.Tests
{
	...
	[TestFixture()]
	public class UXileCalculator_Tests
	{
		[Test()]
		...
		[Test()]
		public void Calculator_Gets_Expected_Quartiles ()
		{
			List<double> sortedData;
			var calculator = HelperMethods.NewInstanceOf<UXileCalculator> (out sortedData, size: 100);
		...
		[Test()]
		public void Calculator_Gets_Expected_Deciles ()
		{
			List<double> sortedData;
			var calculator = HelperMethods.NewInstanceOf<UXileCalculator> (out sortedData, size: 100);
		...
		[Test()]
		public void Calculator_Gets_Expected_Percentiles ()
		{
			List<double> sortedData;
			var calculator = HelperMethods.NewInstanceOf<UXileCalculator> (out sortedData, size: 100);
		...
		static IEnumerable<double> GetXiles (int xile, Func<int,double> nThXile)
		{
