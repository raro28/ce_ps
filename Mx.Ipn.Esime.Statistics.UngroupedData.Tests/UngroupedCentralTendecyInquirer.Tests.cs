namespace Mx.Ipn.Esime.Statistics.UngroupedData.Tests
{
	...
	[TestFixture()]
	public class UngroupedCentralTendecyInquirer_Tests
	{
		[Test()]
		public void Inquirer_Uses_Internal_Sorted_Data_Set ()
		{
			List<double> sortedData;
			var calculator = HelperMethods.NewInstanceOf<UngroupedCentralTendecyInquirer> (out sortedData, size: 100);
		...
		public void Inquirer_Gets_Expected_Mode ()
		{
			...
			var calculator = HelperMethods.NewInstanceOf<UngroupedCentralTendecyInquirer> (ref sortedData);
		...
		public static void Inquirer_Gets_Expected_Mode (List<double> sortedData, dynamic calculator)
		{
			...
			calculator = HelperMethods.NewInstanceOf<UngroupedCentralTendecyInquirer> (ref sortedData);
